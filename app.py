...
def detect_n_plot(frame, detect_eyes=True, detect_smile=True):
    """
    @Parameters:
    ...
    for (face_x, face_y, face_w, face_h) in faces:
        ...
        cv2.putText(frame, "Face", (face_x, face_y - 5), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 0, 0))
...
if __name__ == '__main__':
    ...
    while True:
        ...
        result = detect_n_plot(frame, detect_smile=False)
